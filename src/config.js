...
const options = {
  init_phones: ["HTH67"], // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
  ...
  headerLogoText: null, // If alt_header is enabled, these are the items added to the header
